package cn.ai.sales.module.system.service.social;
...
import cn.ai.sales.framework.common.util.cache.CacheUtils;
import cn.ai.sales.framework.common.util.http.HttpUtils;
import cn.ai.sales.framework.common.util.object.BeanUtils;
import cn.ai.sales.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.ai.sales.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.ai.sales.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.ai.sales.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.ai.sales.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.ai.sales.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.ai.sales.module.system.dal.dataobject.social.SocialClientDO;
import cn.ai.sales.module.system.dal.mysql.social.SocialClientMapper;
import cn.ai.sales.module.system.dal.redis.RedisKeyConstants;
import cn.ai.sales.module.system.enums.social.SocialTypeEnum;
import cn.ai.sales.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.ai.sales.framework.common.util.collection.MapUtils.findAndThen;
import static cn.ai.sales.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.ai.sales.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.ai.sales.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${sales.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${sales.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/sales-cloud/pulls/230
