package cn.ai.sales.module.system.controller.admin.socail.vo.client;

import cn.hutool.core.util.StrUtil;
import cn.ai.sales.framework.common.enums.CommonStatusEnum;
import cn.ai.sales.framework.common.enums.UserTypeEnum;
import cn.ai.sales.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "sales商城")
