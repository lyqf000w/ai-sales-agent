package cn.ai.sales.framework.tracer.config;

import cn.ai.sales.framework.common.enums.WebFilterOrderEnum;
import cn.ai.sales.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "sales.tracer", value = "enable", matchIfMissing = true)
public class SalesTracerAutoConfiguration {
