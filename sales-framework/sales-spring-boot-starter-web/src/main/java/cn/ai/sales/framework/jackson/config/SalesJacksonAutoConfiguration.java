package cn.ai.sales.framework.jackson.config;

import cn.ai.sales.framework.common.util.json.JsonUtils;
import cn.ai.sales.framework.common.util.json.databind.NumberSerializer;
import cn.ai.sales.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.ai.sales.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class SalesJacksonAutoConfiguration {
