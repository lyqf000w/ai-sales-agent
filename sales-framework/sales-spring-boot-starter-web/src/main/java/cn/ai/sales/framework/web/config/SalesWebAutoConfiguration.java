package cn.ai.sales.framework.web.config;
...
import cn.ai.sales.framework.web.core.filter.CacheRequestBodyFilter;
import cn.ai.sales.framework.web.core.filter.DemoFilter;
import cn.ai.sales.framework.web.core.handler.GlobalExceptionHandler;
import cn.ai.sales.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class SalesWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "sales.demo", havingValue = "true")
