...
import { normalizeRenderableResourceUrl } from '@/utils/resourceUrl'
...
const normalizeUserInfo = (userInfo: any) => {
  if (userInfo?.user?.avatar) {
    userInfo.user.avatar = normalizeRenderableResourceUrl(userInfo.user.avatar)
  }
  return userInfo
}
...
export const useUserStore = defineStore('admin-user', {
  ...
  actions: {
    ...
    async setUserAvatarAction(avatar: string) {
      ...
      const normalizedAvatar = normalizeRenderableResourceUrl(avatar)
