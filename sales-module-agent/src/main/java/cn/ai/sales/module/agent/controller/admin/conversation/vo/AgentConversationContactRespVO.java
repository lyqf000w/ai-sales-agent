...
@Schema(description = "管理后台 - AI 销冠会话好友队列 Response VO")
@Data
public class AgentConversationContactRespVO {
    ...
    @Schema(description = "Display name for UI", example = "Zhang San")
    ...
    @Schema(description = "连续自动回复次数", example = "0")
