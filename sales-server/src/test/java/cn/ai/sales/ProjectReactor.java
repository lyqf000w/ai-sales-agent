...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.ai.sales";
    private static final String ARTIFACT_ID = "sales";
    private static final String PACKAGE_NAME = "cn.ai.sales";
    private static final String TITLE = "ai销冠";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.ai.sales";
        String artifactIdNew = "sales";
        String packageNameNew = "cn.ai.sales";
        String titleNew = "ai销冠";
        File projectBase = new File(projectBaseDir);
        String projectBaseDirNew = projectBase.getParent() + separator
                + projectBase.getName().replace(ARTIFACT_ID, artifactIdNew); // 一键改名后，“新”项目所在的目录
