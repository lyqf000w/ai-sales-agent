package cn.ai.sales.module.infra.controller.admin.job.vo.job;
...
import cn.ai.sales.module.infra.enums.DictTypeConstants;
...
public class JobRespVO {
    ...
    @Schema(description = "处理器的参数", example = "sales")
